...
const buildPrompt = (analysisType, workouts, goals) => {
  let prompt = "";
...
export const analyzeWorkouts = async (req, res) => {
  try {
    const { analysisType, workouts, goals } = req.body;
    ...
    const validTypes = ["general", "progression", "recovery", "technique"];
    ...
    const prompt = buildPrompt(analysisType, workouts, goals);
