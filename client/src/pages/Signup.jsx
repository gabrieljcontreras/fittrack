  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-zinc-900 border border-zinc-800 p-12">
        <div className="mb-10">
          <p className="text-zinc-500 text-xs font-medium tracking-widest uppercase mb-4">CREATE ACCOUNT</p>
          <h2 className="text-4xl font-light tracking-tight text-white">Get Started</h2>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-zinc-800">
          <p className="text-center text-zinc-500 font-light tracking-wide text-sm">
            ...
            <Link to="/login" className="text-white hover:text-zinc-300 font-medium uppercase text-xs tracking-widest">
              Sign In
            </Link>
          </p>
        </div>
